...
if response.status_code == 200:
    with open(r'/home/ioc-bot/Desktop/IOCs/week.csv', 'w') as f:
...
with open(r'/home/ioc-bot/Desktop/IOCs/week.csv', newline='') as csvfile:
...
base_path = os.path.dirname(r'/home/ioc-bot/Desktop/IOCs/week.csv')
